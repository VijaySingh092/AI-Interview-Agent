        ...
        <div className='space-y-5'>
          {
            [
              ...
              className='flex items-center space-x-4 bg-white p-4 rounded-xl shadow-sm cursor-pointer'>{moveItem.icon}
              <span className='text-gray-700 font-medium'>{moveItem.text}</span>
              </motion.div>
            ))
          }
        </div>
        ...
        className='p-12 bg-white'>
          ...
          <div className='space-y-6'>
            ...
            <div className='relative'>
              ...
              className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:right-green-500 outline-none transition' 
              ...
              {analysisDone && (
                ...
                className='bg-gray-50 border border-gray-200 rounded-xl p-5 space-y-4'>
                 ...
                 {skills.length>0 &&(
                  ...
                  <p className='font-medium text-gray-700 mb-1'>
                    Skills:</p>
                    <div className='flex flex-wrap gap-2 w-full overflow-hidden text-gray-600 space-y-1'>
                      {skills.map((s,i)=>(
                        <span key={i} className='bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm white '>{s}</span>
                      ))}
                    </div>
                    </div>
                 )}
