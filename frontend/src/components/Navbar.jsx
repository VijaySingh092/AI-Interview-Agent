...
const Navbar = () => {
  ...
  return (
    <div className='bg-[#f3f3f3]  flex justify-center px-4 pt-6'>
      ...
      className='w-full max-w-6xl border-gray-200 bg-white rounded-3xl shadow-sm border px-8 py-4 flex justify-between items-center relative'>
        ...
        <div className='flex items-center gap-6 relative'>
            ...
            <div className='relative'>
                ...
                {showUserPopup && (
                    <div className='absolute right-0mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50'>
